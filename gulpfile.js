...
const path = {
	...
	src: {
		...
		images: srcPath + "assets/img/**/*.{jpg,png,svg,gif,ico,webp,webmanifest,xgulml,json}",
...
const build = gulp.series(clean, gulp.parallel(html, css, js, images, fonts, video, svg, libs, fav));
